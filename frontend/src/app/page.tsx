...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-purple-950">
      <div className="bg-blue-500 rounded-2xl shadow-lg p-8 w-[30%] h-75 text-black">
          <form className="flex flex-col space-y-6" onClick={signIn}>
            ...
            <button
              type="submit"
              className="bg-purple-700 hover:bg-purple-800 text-white font-bold py-2 rounded-md transition"
            >
              Sign In
            </button>
          </form>
